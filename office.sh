...
if [ $s_bit==64 ];then
   ...
   wget https://sourceforge.net/projects/openofficeorg.mirror/files/4.1.5/binaries/zh-CN/Apache_OpenOffice_4.1.5_Linux_x86-64_install-deb_zh-CN.tar.gz/download; 
   echo "下载完毕，开始解压文件";
   cd  /home/software/download/openoffice/;
   tar -xvzf Apache_OpenOffice_4.1.5_Linux_x86-64_install-deb_zh-CN.tar.gz;
else
   echo "开始下载32位的openoffice"；
   wget https://sourceforge.net/projects/openofficeorg.mirror/files/4.1.5/binaries/zh-CN/Apache_OpenOffice_4.1.5_Linux_x86_install-deb_zh-CN.tar.gz/download;
   echo "下载完毕，开始解压文件";
   cd  /home/software/download/openoffice/;
   tar -xvzf Apache_OpenOffice_4.1.5_Linux_x86_install-deb_zh-CN.tar.gz;
fi
